    ...
    return (
      <div className="combined-wrapper">
        <div className="combined-reload">
          <Button shape="circle" icon={<ReloadOutlined />} onClick={this.onClick} />
        </div>
        {this.state.show && (
          <div className="combined">
            <div className="combined-shape">
              <div className="shape-left">
                <TweenOne
                  animation={[
                    { x: 150, type: 'from', ease: 'easeInOutQuint', duration: 600 },
            ...
            <Texty
              ...
              interval={30}
            >
              Backstage Management System is basic build by React Framwork.
            </Texty>
          </div>
        )}
      </div>
